        ...
        Panel.fit(
            "\n".join(
                [
                    ...
                    "",
                    "[1] Today                   [dim]waymark today[/dim]",
                    "[2] Capture a Moment        [dim]waymark capture[/dim]",
                    "[3] Ask Waymark             [dim]waymark ask QUERY[/dim]",
                    "[4] Timeline                [dim]waymark timeline[/dim]",
                    "[5] Reflect                 [dim]waymark reflect[/dim]",
                    "[6] Decisions               [dim]waymark decision list[/dim]",
                    "[7] Import My World         [dim]waymark import markdown FILE[/dim]",
                    "[8] Export Markdown         [dim]waymark export timeline FILE[/dim]",
                    "[9] Journey Map             [dim]waymark journey[/dim]",
                    "[10] Setup / Doctor         [dim]waymark doctor[/dim]",
                    "",
