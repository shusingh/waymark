...
wheel and source archive. The current public release is `v0.1.0`.
...
```bash
pipx install https://github.com/shusingh/waymark/releases/download/v0.1.0/waymark-0.1.0-py3-none-any.whl
```
